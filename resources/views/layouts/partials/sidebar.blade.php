...
<nav class="pcoded-navbar">
  <div class="nav-list">
    <div class="pcoded-inner-navbar main-menu">
      <div class="pcoded-navigation-label">ပင်မ</div>
        ...
        <div class="pcoded-navigation-label">ဂိမ်း</div>
        <ul class="pcoded-item pcoded-left-item">
...
<nav class="pcoded-navbar">
  <div class="nav-list">
    <div class="pcoded-inner-navbar main-menu">
      <div class="pcoded-navigation-label">ပင်မ</div>
        <ul class="pcoded-item pcoded-left-item">
          <li class="{{ request()->routeIs('super.dashboard') ? 'active' : '' }}">
            <a href="{{ route('super.dashboard') }}" class="waves-effect waves-dark">
              <span class="pcoded-micon">
                <i class="feather icon-home"></i>
              </span>
              <span class="pcoded-mtext">ပင်မ စာမျက်နှာ</span>
        ...
        <div class="pcoded-navigation-label">မိတ်ဖက်များ</div>
        <ul class="pcoded-item pcoded-left-item">
          <li class="{{ request()->routeIs('seniors-lists.index') ? 'active' : '' }}">
            <a href="{{ route('seniors-lists.index') }}" class="waves-effect waves-dark">
              <span class="pcoded-micon">
                <i class="feather icon-home"></i>
              </span>
              <span class="pcoded-mtext">စီနီယာများ</span>
          ...
          <li class="{{ request()->routeIs('super.masters-lists') ? 'active' : '' }}">
            <a href="{{ route('super.masters-lists') }}" class="waves-effect waves-dark">
              <span class="pcoded-micon">
                <i class="feather icon-home"></i>
              </span>
              <span class="pcoded-mtext">မာစတာများ</span>
          ...
          <li class="{{ request()->routeIs('super.agents-lists') ? 'active' : '' }}">
            <a href="{{ route('super.agents-lists') }}" class="waves-effect waves-dark">
              <span class="pcoded-micon">
                <i class="feather icon-home"></i>
              </span>
              <span class="pcoded-mtext">အေးဂျင့်များ</span>
          ...
          <li class="{{ request()->routeIs('super.users-lists') ? 'active' : '' }}">
            <a href="{{ route('super.users-lists') }}" class="waves-effect waves-dark">
              <span class="pcoded-micon">
                <i class="feather icon-home"></i>
              </span>
              <span class="pcoded-mtext">ယူဆာများ</span>
