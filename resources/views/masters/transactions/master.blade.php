...
@section('title', 'ထည့်/ထုတ် မှတ်တမ်း')
@section('content')
                  ...
                  <div class="dt-responsive table-responsive">
                    <table id="transactions" class="table table-bordered table-hover nowrap">
                      ...
                      <tfoot class="text-right">
                        <tr>
                          <th colspan="4" class="bg-dark text-white">Total :</th>
                          <th></th>
                        </tr>
                      </tfoot>
                    </table>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('#transactions').DataTable({
      ...
      responsive: true,
      ajax: {
        url: "{{ route('master.master-transactions') }}",
        data: function (d) {    
          d.date_range = $('#date_filter').val();
          d.status = $('#js-example-basic-single').val();
        }
      },
      columns: [
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        $( api.column( 4 ).footer() ).html(amount.toLocaleString("en"));
      },
    });
